...
import mira from "./../../../images/personal-social5to/mira.jpg"
import ecua from "./../../../images/personal-social5to/ecua.jpg"
import col from "./../../../images/personal-social5to/col.jpg"
import bra from "./../../../images/personal-social5to/bra.jpg"
import chi from "./../../../images/personal-social5to/chi.jpg"
import bol from "./../../../images/personal-social5to/bol.jpg"
  ...
  return (
    ...
    <h2>Geografía del Perú</h2>
           ...
           <div class="blogText">
            ...
            <img src={mira} className="centralImage" alt="Miraflores de noche"/>
            ...
            <img src={ecua} className="centralImage" alt="Bandera de Ecuador"/>
            ...
            <img src={col} className="centralImage" alt="Bandera de Colombia"/>
            ...
            <img src={bra} className="centralImage" alt="Bandera de Brasil"/>
            ...
            <img src={chi} className="centralImage" alt="Bandera de Chile"/>
            ...
            <img src={bol} className="centralImage" alt="Bandera de Bolivia"/>
             <div class="autor">
