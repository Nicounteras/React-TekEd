...
function Quizzes() {
  ...
  <div className="quizInitialDiv waiting">
    ...
    <div className="central2x2">
      <Link to="/quizzes/quinto-grado"><button className="bigButtonRed">5to Grado</button></Link>
      <Link to="/quizzes/sexto-grado"><button className="bigButtonPurple">6to Grado</button></Link>
    </div>
