 ...
 return(
    ...
    <div className="doodle">
      <div className="blogLayout">
        ...
        <p>Cuando empiezas a programar, ya sea en el lenguaje que escogas, tienes que aprender a escribir tu código mediante la lógica. Mientras estés desarrollando tu código, probablemente se te presenten algunos problemas (puede ser desde una estrucutura de código hasta un algoritmo complejo). La resolución de estos problemas de lógica además de llevarte al resultado que buscas, te ayudarám muchísimo a mejorar tu pensamiento crítico y creatividad.</p>
