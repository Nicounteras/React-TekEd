...
function PersonalInitial() {
  ...
  <div className="devInitial">
    ...
    <h3>Mejora en humanidades con <span className="teked">Tek<span>Ed</span></span></h3>
    ...
    <div className="twoGrid">
      <Link to="/aprende/quinto-grado/personal-social" className="btnInit red cool-link">5to de primaria</Link>
      <Link to="/aprende/sexto-grado/humanidades" className="btnInit orange cool-link">6to de primaria</Link>
    </div>
    ...
    <h3>¿En qué grado estás?</h3>
    <div className="twoGrid">
      <Link to="/ejercicios/quinto-grado/personal-social" className="btnInit red cool-link">5to de primaria</Link>
      <Link to="/ejercicios/sexto-grado/humanidades" className="btnInit orange cool-link">6to de primaria</Link>
    </div>
