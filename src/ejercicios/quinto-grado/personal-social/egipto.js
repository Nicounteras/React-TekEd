...
function EgiptoQuintoEj() {
  const [flashcards, setFlashcards] = useState(FlashCards)
  return (
   <>
<Nav/>
<div className="buttonDivTo">
<Link to="/aprende/quinto-grado/personal-social/contexto-peruano" className="goToOtherArticle cool-link">
  Leer el artículo
</Link>
</div>
<Rail/>
