...
export default function CompoHTML () {
        return (
            ...
            <h1 id="htmlHead">Composición de HTML</h1>
                ...
                <div id="twoButtonDev">
                <Link to="/desarrollo-web/curso-html/instalacion" className="theDevLink devBTN">&lArr; Instalación</Link>
                <div className="flexing"/>
                <Link to="/desarrollo-web/curso-html/meta-tags" className="theDevLink devBTN">Meta Tags &rArr;</Link>
                </div>
            </div>
            </>
        )
